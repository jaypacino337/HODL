...
fs.writeFileSync(path.join(__dirname, 'build.json'), JSON.stringify(artifacts));
console.log(`built: ${Object.keys(artifacts).join(', ')} (${errs.length} errors, ${warns.length} warnings)`);
