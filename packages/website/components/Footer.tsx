...
export function Footer() {
  return (
    <footer className="border-t border-ember-700/30 bg-stage-950 px-4 py-10">
      <div className="mx-auto max-w-5xl text-center text-sm text-amber-100/60">
        <div className="font-display text-xl uppercase tracking-wide text-gold-metal">
          HODL OR NO HODL
        </div>
        {MINT_ADDRESS && (
        ...
        <p className="mx-auto mt-4 max-w-xl text-xs leading-relaxed text-amber-100/40">
